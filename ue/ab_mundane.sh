...
$PY ue/isp_post.py "C:/ue/out_ab/src/*.png" C:/ue/out_ab/hist --hist-only
for P in default mundane; do
  $PY ue/neural_refine.py --src "C:/ue/out_ab/hist/*.png" --out /c/ue/out_ab/nr_$P --strength 0.3 --cn 0.6 --preset $P
  $PY ue/isp_post.py "C:/ue/out_ab/nr_$P/*.jpg" C:/ue/out_ab/fin_$P
  echo "== $P =="
  $PY ue/realism_metric.py --fake "C:/ue/out_ab/fin_$P/*.jpg" --real "C:/ue/ref_all/*.jpg"
  $PY ue/skvd_metric.py --fake "C:/ue/out_ab/fin_$P/*.jpg" --real "C:/ue/ref_all/*.jpg"
done
echo AB_DONE
