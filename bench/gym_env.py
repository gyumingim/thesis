...
class IntersectionVectorEnv(gym.vector.VectorEnv):
    ...
    def __init__(self, num_envs, n_vehicles=3, seed=0):
        # n_vehicles=4: 50m 내 실측기하 맵에서 V=2가 노출 1.18대로 MD(1.3) 최근접 (2026-08-20 R6) → MetaDrive 실측(1.3대/최대 3) 정합 (2026-08-20)
