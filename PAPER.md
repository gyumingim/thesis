...
**실행 기동별 성능** (거버너 ON + 마스킹; n=180 — 위 구성 A·B 표의 셀과는 **다른 에피소드 집합**이다. 이 풀의 전체 성공은 158/180 = 87.8%, 유턴 제외 140/152 = 92.1%. 원자료: `bench_results/carla/evolve*/`). 조건 라벨은 앵커의 진입/이탈 방위차가
