...
못한다는 선행(Khor & Weng, SCC≈−0.3)과 방향이 같다. 한계도 함께 적는다 — 경량 학습 수익
L 의 동적 범위가 평균(약 115)의 1% 수준이라 사실상 포화된 신호 위에서 순위를 읽고 있으므로,
"예측력이 없다"는 결론도 이 과제·이 신호에 한정된다. 다만 여기의 τ≈0 은 확정 정숙 조건 5시드에서 산출한
