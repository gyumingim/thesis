...
놓이는 배치 분포**가 학습과 평가에서 어긋나 있었다. 따라서 위 36pp 는 (i) 장면 구성,
(ii) 데이터 규모에 더해 (iii) 통행 방향까지 세 요인이 섞인 값이다. 세 팔이 같은 결함을
공유하므로 **팔 간 상대 비교(정제 +7.2pp)는 유효**하나, 실사 상한과의 절대 격차 해석은 이
요인을 분리한 뒤에야 가능하다. 같은 감사에서 완전 가림 라벨 20.7~22.8%(장면의 76~80%에
