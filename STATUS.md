...
- **MetaDrive 병렬 기준선 완료 (2026-08-20)** — 정점 12프로세스 6,965 SPS (16은 SMT 경합으로 하락)
  - **공정 비교 확정: Numba 4.15M ÷ 6,965 ≈ 595배** — 논문 헤드라인은 ~600배로 사용
- **사용자 확정 (2026-08-20):** ① 작업 순서 = 병렬 기준선 → 환경 완성 → PPO
  ② V≤16 고정 + Numba 단독 채택 (V=64 GPU 역전은 관찰로만 언급)
- 다음: 환경 완성 — 관측 51차원 의미론 정합, 밀집 보상, 차선 기하 이탈 판정, NPC 경로 추종
